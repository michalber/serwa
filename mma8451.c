...
//        accel_x >>= 2;
        ...
        accel_x   = hal_dev_mma8451_read_reg(ACCEL_XOUT_H)<<8;
        accel_x  |= hal_dev_mma8451_read_reg(ACCEL_XOUT_L);
				accel_x >>= 2;
//        accel_y   = hal_dev_mma8451_read_reg(0x03)<<8;
//        accel_y  |= hal_dev_mma8451_read_reg(0x04);
//        accel_y >>= 2;
			
        accel_y   = hal_dev_mma8451_read_reg(ACCEL_YOUT_H)<<8;
        accel_y  |= hal_dev_mma8451_read_reg(ACCEL_YOUT_L);
        accel_y >>= 2;
...
//        accel_z >>= 2;
        ...
        accel_z   = hal_dev_mma8451_read_reg(ACCEL_ZOUT_H )<<8;
        accel_z  |= hal_dev_mma8451_read_reg(ACCEL_ZOUT_L);
        accel_z >>= 2;
...
uint8_t hal_dev_mma8451_read_reg(uint8_t addr)
{
   ...
   // i2c_write_byte(I2C0_B, MMA8451_I2C_ADDRESS | I2C_WRITE);
        i2c_write_byte(I2C0_B, MPU9250_ADDRESS | I2C_WRITE);
    i2c_wait(I2C0_B);
    i2c_get_ack(I2C0_B);
   ...
   // i2c_write_byte(I2C0_B, MMA8451_I2C_ADDRESS | I2C_READ);
	    i2c_write_byte(I2C0_B, MPU9250_ADDRESS | I2C_READ);
    i2c_wait(I2C0_B);
    i2c_get_ack(I2C0_B);
